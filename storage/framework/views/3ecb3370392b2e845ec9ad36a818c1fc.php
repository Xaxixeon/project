...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold mb-1 text-white">Welcome, <?php echo e($customer->name); ?></h2>
        ...
        <?php if($customer->memberType): ?>
            <span class="px-3 py-2 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-300 border border-emerald-400/30">
                <?php echo e($customer->memberType->name); ?> Tier
            </span>
        <?php endif; ?>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="glass rounded-xl border border-white/10 p-4 shadow-lg shadow-black/30">
            ...
            <div class="text-3xl font-bold text-white mt-1"><?php echo e($customer->orders()->count()); ?></div>
        </div>

        <div class="glass rounded-xl border border-white/10 p-4 shadow-lg shadow-black/30">
            <div class="text-slate-400 text-sm">Orders in Progress</div>
            <div class="text-3xl font-bold text-white mt-1">
                <?php echo e($customer->orders()->whereNotIn('status',['completed'])->count()); ?>
        ...
        <div class="glass rounded-xl border border-white/10 p-4 shadow-lg shadow-black/30">
            ...
            <div class="text-3xl font-bold text-white mt-1">
                <?php echo e($customer->orders()->where('status','completed')->count()); ?>
    ...
    <div class="glass rounded-xl border border-white/10 p-5 shadow-lg shadow-black/30">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('customer.orders.index')); ?>" class="text-xs text-indigo-300 hover:text-indigo-200">Lihat semua</a>
        </div>
            ...
            <table class="w-full text-sm text-slate-200">
                ...
                <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-t border-white/5 hover:bg-white/5">
                        <td class="p-3 font-semibold">#<?php echo e($order->id); ?></td>
                        <td class="p-3">
                        ...
                        <td class="p-3">
                            Rp <?php echo e(number_format($order->total_price ?? $order->total ?? 0)); ?>

                        </td>
                        <td class="p-3"><?php echo e($order->created_at?->format('d M Y')); ?></td>
                        <td class="p-3 text-right">
                            <a href="<?php echo e(route('customer.orders.show', $order)); ?>" class="text-indigo-300 hover:text-indigo-100 text-xs">
                                Detail
                            </a>
                        </td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\xeon\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>