...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-md">
        ...
        <p class="mt-4 text-center text-sm">
            Belum punya akun?
            <a href="<?php echo e(route('customer.register')); ?>" class="text-blue-600 hover:underline">
                Daftar di sini
            </a>
        </p>
    </div>
...
<?php /**PATH C:\xampp\htdocs\xeon\resources\views/auth/customer/login.blade.php ENDPATH**/ ?>