<div 
    x-data="{ open: false, query: '', commands: [
        {name: 'Dashboard', url: '<?php echo e(route('dashboard.admin')); ?>'},
        {name: 'Staff Management', url: '<?php echo e(route('admin.staff.index')); ?>'},
        {name: 'Customers', url: '<?php echo e(route('admin.customers.index')); ?>'},
        {name: 'Instansi', url: '<?php echo e(route('admin.instansi.index')); ?>'},
        {name: 'Member Types', url: '<?php echo e(route('admin.member.index')); ?>'},
        {name: 'Pricing', url: '<?php echo e(route('admin.pricing.index')); ?>'},
        {name: 'Orders', url: '<?php echo e(route('orders.index')); ?>'},
    ] }"
...
<?php /**PATH C:\xampp\htdocs\xeon\resources\views/components/admin/command-palette.blade.php ENDPATH**/ ?>