...
<header class="fixed top-0 inset-x-0 z-40 bg-slate-950/80 backdrop-blur border-b border-slate-800">
    <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="hover:text-sky-400 transition">Katalog</a>
    ...
    <div id="landing-menu" class="md:hidden hidden border-t border-slate-800 bg-slate-950">
        <div class="max-w-6xl mx-auto px-4 py-3 flex flex-col gap-2 text-sm">
            ...
            <?php if(auth('customer')->check()): ?>
                <a href="<?php echo e(route('customer.dashboard')); ?>" class="hover:text-sky-400 transition">Dashboard Customer</a>
            <?php elseif(auth('staff')->check()): ?>
                <a href="<?php echo e(route('staff.dashboard')); ?>" class="hover:text-sky-400 transition">Panel Staff</a>
            <?php else: ?>
                <a href="<?php echo e(route('customer.login')); ?>" class="hover:text-sky-400 transition">Login Customer</a>
                <a href="<?php echo e(route('staff.login')); ?>" class="hover:text-sky-400 transition">Login Staff</a>
            <?php endif; ?>
            <button type="button"
                    onclick="document.getElementById('contact-modal').classList.remove('hidden')"
    ...
    <section id="katalog" class="border-t border-slate-800 bg-slate-950">
        <div class="max-w-6xl mx-auto px-4 py-10 md:py-14 space-y-5">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('products.index')); ?>"
                   class="text-xs md:text-sm text-sky-400 hover:underline">
                    Lihat semua katalog →
                </a>
            </div>
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-5">
                <?php $__empty_1 = true; $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 flex flex-col justify-between hover:border-sky-500/60 hover:-translate-y-1 hover:shadow-xl hover:shadow-sky-500/10 transition duration-200">
                        <div>
                        ...
                        <div class="flex items-center justify-between mt-1">
                            <div class="text-xs text-sky-300 font-semibold">
                                <?php echo e($product->display_price ?? 'Harga variatif'); ?>
    ...
    <section id="event" class="border-t border-slate-800 bg-slate-950">
        <div class="max-w-6xl mx-auto px-4 py-10 md:py-14 space-y-4">
            ...
            <div class="grid md:grid-cols-2 gap-5 text-sm">
                <div class="bg-gradient-to-r from-sky-600/20 via-sky-500/10 to-slate-900 border border-sky-500/40 rounded-2xl p-4 md:p-5">
...
<footer class="border-t border-slate-800 bg-slate-950 py-4 text-[11px] text-slate-500 text-center">
    © <?php echo e(date('Y')); ?> Xeon Digital Printing. All rights reserved.
</footer>
...
<?php /**PATH C:\xampp\htdocs\xeon\resources\views/landing/index.blade.php ENDPATH**/ ?>