...
<body class="min-h-screen bg-slate-950 text-slate-50 flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-slate-900/80 border border-slate-800 rounded-2xl shadow-2xl p-6 md:p-8">
        ...
        <form method="POST" action="<?php echo e(route('staff.login.post')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="mt-6 text-center text-xs text-slate-500">
            Bukan staff? <a href="<?php echo e(route('customer.login')); ?>" class="text-sky-400 hover:underline">Login customer</a> atau
            <a href="<?php echo e(route('auth.portal')); ?>" class="text-sky-400 hover:underline">pilih portal</a>.
        </p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\xeon\resources\views/auth/staff-login.blade.php ENDPATH**/ ?>