        ...
        <tbody class="bg-slate-900/60">
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="border-b border-slate-800 hover:bg-slate-800/60 transition">
                    <td class="p-3 text-slate-100"><?php echo e($product->name); ?></td>
                    ...
                    <td class="p-3">
                        <input type="number" step="100" name="prices[<?php echo e($product->id); ?>]" value="<?php echo e($price); ?>"
...
<?php /**PATH C:\xampp\htdocs\xeon\resources\views/admin/pricing/components/price-table.blade.php ENDPATH**/ ?>