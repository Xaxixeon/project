...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($product->name); ?> – Xeon Digital Printing</title>
...
<header class="border-b border-slate-800 bg-slate-950/80 backdrop-blur">
    <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        <a href="<?php echo e(route('products.index')); ?>" class="flex items-center gap-3">
...
<main class="min-h-screen bg-gradient-to-b from-slate-950 via-slate-950 to-slate-900">
    <div class="max-w-6xl mx-auto px-4 py-10 md:py-14 space-y-8">
        ...
        <nav class="text-base text-slate-400 mb-2">
            <a href="<?php echo e(route('home')); ?>" class="hover:text-sky-300">Beranda</a>
            <span class="mx-1">/</span>
            <a href="<?php echo e(route('products.index')); ?>" class="hover:text-sky-300">Katalog</a>
            <span class="mx-1">/</span>
            <span class="text-slate-300"><?php echo e($product->name); ?></span>
        </nav>
        ...
        <div class="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <section class="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-xl space-y-4">
                ...
                <p class="text-base text-slate-400">
                    SKU: <span class="font-mono text-slate-300"><?php echo e($product->sku); ?></span>
                </p>
                ...
                <div class="mt-4 space-y-2">
                    ...
                    <div class="text-2xl font-bold text-sky-300">
                        <?php echo e($product->display_price ?? 'Harga variatif sesuai ukuran & bahan'); ?>
            ...
            <section id="order" class="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-xl">
                ...
                <form method="POST" action="<?php echo e(route('order.store')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                        ...
                        <label for="variant_id" class="text-xs font-semibold">Pilih varian</label>
                            <select id="variant_id" name="variant_id"
                                ...
                                <?php $__currentLoopData = $product->variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    data-price="<?php echo e($variant->priceForCustomer($customer ?? null)); ?>"
                                    data-width="<?php echo e($variant->width_cm ?? 0); ?>"
                                    data-height="<?php echo e($variant->height_cm ?? 0); ?>"
                                >
                                    <?php echo e($variant->label); ?>

                                    — Rp <?php echo e(number_format($variant->priceForCustomer($customer ?? null), 0, ',', '.')); ?>
                            ...
                            <?php $__currentLoopData = $product->addons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center gap-2 text-xs text-slate-800">
                                    <input type="checkbox"
                                           ...
                                           data-extra-price="<?php echo e($addon->extra_price); ?>"
                                           class="rounded border-slate-400">
                                    <span><?php echo e($addon->name); ?></span>
                                    <?php if($addon->extra_price > 0): ?>
                                        <span class="text-sky-600">
                                            + Rp <?php echo e(number_format($addon->extra_price,0,',','.')); ?>
...
<?php /**PATH C:\xampp\htdocs\xeon\resources\views/products/show.blade.php ENDPATH**/ ?>