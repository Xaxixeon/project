            ...
            <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="text-right">
                        <div class="text-sm font-semibold"><?php echo e(auth('customer')->user()->name ?? 'Customer'); ?></div>
                        <?php if(auth('customer')->user()?->memberType): ?>
                            <div class="text-xs text-emerald-300">Tier: <?php echo e(auth('customer')->user()->memberType->name); ?></div>
                        <?php endif; ?>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\xeon\resources\views/components/customer/layout.blade.php ENDPATH**/ ?>